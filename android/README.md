...
`org.workchat.voip.sdk.JitsiMeetActivity`:
...
Alternatively, you can use the `org.workchat.voip.sdk.JitsiMeetView` class which
...
import org.workchat.voip.sdk.JitsiMeetView;
import org.workchat.voip.sdk.ReactActivityLifecycleCallbacks;
