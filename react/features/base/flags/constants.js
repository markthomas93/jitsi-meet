 ...
 * Default: enabled (true).
 */
export const MOREOPTIONS_ENABLED = 'more.optionals.enabled';

/**
 * Filmstrip should be enabled.
 * Default: enabled (true).
 */
 ...
 * Default: enabled (true).
 */
export const FILMSTRIP_SHOW_BOTTOM_ENABLED = 'filmstrip.show.bottom.enabled';

/**
 * User join should be enabled.
 * Default: enabled (true).
 */
export const USER_JION_ENABLED = 'user.join.enabled';
