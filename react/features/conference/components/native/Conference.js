...
import { PIP_ENABLED, FILMSTRIP_ENABLED, USER_JION_ENABLED, FILMSTRIP_SHOW_BOTTOM_ENABLED, getFeatureFlag } from '../../../base/flags';
...
class Conference extends AbstractConference<Props, *> {
    ...
    _renderContent() {
        ...
        const applyGradientStretching = _filmstripVisible && _filmstripEnable && isNarrowAspectRatio(this) && !_shouldDisplayTileView;
            ...
            <>
                ...
                <SafeAreaView
                    ...
                    {/*
                      ...
                      */
                     _filmstripShowBottomEnable ? 
                        _shouldDisplayTileView ? undefined : _filmstripEnable ? <Filmstrip /> : undefined
                     :undefined
                    }
                ...
                <SafeAreaView
                    ...
                    {/*
                      ...
                      * participants.
                      */
                     _filmstripShowBottomEnable == false ? 
                        _shouldDisplayTileView ? undefined : _filmstripEnable ? <Filmstrip /> : undefined
                     :undefined
                    }
                    { _userJoinEnabled == true ? this._renderNotificationsContainer():undefined }
                </SafeAreaView>
    ...
    _renderNotificationsContainer() {
        ...
        // added here.
        if (this.props._filmstripVisible && this.props._filmstripEnable && !isNarrowAspectRatio(this)) {
...
function _mapStateToProps(state) {
    ...
    return {
         ...
         * Is {@code true} when the filmstrip is currently visible.
         */
        _filmstripEnable: getFeatureFlag(state, FILMSTRIP_ENABLED, true),

        /**
         * Is {@code true} when the filmstrip is currently position.
         * Default: true
         */
        _filmstripShowBottomEnable: getFeatureFlag(state, FILMSTRIP_SHOW_BOTTOM_ENABLED, false),

        
        /**
         * Is {@code true} when user join call
         * Default: false
         */
        _userJoinEnabled: getFeatureFlag(state, USER_JION_ENABLED, false),
