...
import { MOREOPTIONS_ENABLED, getFeatureFlag } from '../../../base/flags';
...
class Toolbox extends PureComponent<Props> {
     ...
     */
    _renderToolbar() {
        const { _moreOptionEnabled, _styles } = this.props;
...
function _mapStateToProps(state: Object): Object {
    return {
        _moreOptionEnabled: getFeatureFlag(state, MOREOPTIONS_ENABLED, false),
